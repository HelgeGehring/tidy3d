...
#        eps_zx, (eps_xy, eps_yz) = self.plane.pop_axis(
#            [eps_tensor[1, ...], eps_tensor[5, ...], eps_tensor[6, ...]],
#            axis=self.normal_axis,
#        )

#        eps_zy, (eps_xz, eps_yx) = self.plane.pop_axis(
#            [eps_tensor[2, ...], eps_tensor[3, ...], eps_tensor[7, ...]],
#            axis=self.normal_axis,
#        )
